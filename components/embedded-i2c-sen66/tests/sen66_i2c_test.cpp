...
TEST (SEN66_Tests, test_get_product_type1) {
    int16_t local_error = 0;
    int8_t product_type[32] = {0};

    local_error = sen66_get_product_type(product_type, 32);
...
TEST (SEN66_Tests, test_perform_co2_sensor_factory_reset1) {
    int16_t local_error = 0;

    local_error = sen66_perform_co2_sensor_factory_reset();
    CHECK_EQUAL_ZERO_TEXT(local_error, "perform_co2_sensor_factory_reset");
}
